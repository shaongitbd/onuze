"""
Django settings for securethread_backend project.
...
ROOT_URLCONF = 'securethread_backend.urls'
...
WSGI_APPLICATION = 'securethread_backend.wsgi.application'
ASGI_APPLICATION = 'securethread_backend.asgi.application'
